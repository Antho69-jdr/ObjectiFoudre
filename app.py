...
# Réglages NON SECRETS exposés à la page maintenance : ils répondent à « ma variable
# est-elle bien posée sur Railway ? », question qui revient à chaque bascule (agrégateur
# de cellule, journal d'ombre GII). Aucune valeur de secret ici — un inventaire des clés
# avait été ajouté puis RETIRÉ à la demande d'Anthony (v1.3.265) : il ne voulait pas voir
# les secrets, seulement ne plus ouvrir les URL admin à la main, ce que fait la carte
# « Outils & diagnostics ».
