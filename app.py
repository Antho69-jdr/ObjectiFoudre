...
def _fr_radar_shapes_features(rgba) -> list:
    ...
    Chaikin ×1 (lissage léger ; ×2 auparavant, allégé v1.3.106 pour la perf de la carte radar
    ...
    for k in range(1, nb + 1):
        ...
        for ring in _fr_marching_rings(mask):
            ...
            if len(dp) < 3:
                continue
            sm = _fr_ring_chaikin(dp, 1)   # v1.3.106 : ×2 → ×1 (perf radar : ~-49 % de sommets, moins de lag)
