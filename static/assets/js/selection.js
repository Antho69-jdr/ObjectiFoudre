    ...
    function openDetails() {
      ...
      dConfidence.textContent = safe(p.confidence_score);
      dConfidenceLabel.textContent = p.confiance || '—';
      ...
      applyMetricTone(dConfidence, 'confidence_score', p.confidence_score);
      ...
      applyMetricTone(dStability, 'stability_score', p.stability_score);
