...
(function () {
  ...
  const OUTILS = [
    { id: 'shadow-rebase',
      ...
      desc: 'Courbe quantile→quantile + seuil, depuis le mode ombre. ⏱️ Le PREMIER clic lance le calcul (plusieurs minutes), le SECOND rend le rapport — sinon Cloudflare coupe à 100 s. C\'est ce JSON qu\'il faut me coller le jour de la bascule.' },
    { id: 'shadow-rebase-rapide', label: 'Ré-ancrage p90 (sans le seuil)', url: '/api/server/shadow-rebase?threshold=0',
      desc: 'Même chose en sautant la partie lente : utile pour vérifier où en est la collecte. Même règle des deux clics.' },
    { id: 'shadow-rebase-refaire', label: 'Ré-ancrage p90 · forcer un recalcul', url: '/api/server/shadow-rebase?refaire=1', lent: true,
      desc: 'Ignore le rapport gardé sur le volume et relance le calcul. À utiliser après un changement de méthode, pas pour rafraîchir.' },
